...
def analyze_output_embedding():
    ...
    file_name = "test_prompt_timer4_rewrite_penalty_0.8_vote1.json"
    with open(f"datasets/TimeQuestions/results/{file_name}", "r") as f:
        data = json.load(f)
    print(file_name)
    ...
    # 결과 저장
    with open("datasets/TimeQuestions/results/output_embedding_analysis.json", "w") as f:
